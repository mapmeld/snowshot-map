  ...
  def __init__(self, server=None, additional_headers=None, 
    ...
    Args:
      ...
      token_store: Keeps a collection of authorization tokens which can be
                   ...
                   and remove_token.
    """
    self.http_client = http_client or atom_http.ProxiedHttpClient()
    self.token_store = token_store or atom_token_store.TokenStore()
    self.server = server
...
class BasicAuthToken(atom_http_interface.GenericToken):
...
def DictionaryToParamList(url_parameters, escape_params=True):
  ...
  This function is deprcated, use atom_url.Url instead.
...
def HttpRequest(service, operation, data, uri, extra_headers=None, 
  ...
  This method is deprecated, use atom_http.HttpClient.request instead.

  Usage example, perform and HTTP GET on http://www.google.com/:
    import atom_service as atomservice
    client = atomservice.AtomService()
...
def __SendDataPart(data, connection):
  """This method is deprecated, use atom_http._send_data_part"""
