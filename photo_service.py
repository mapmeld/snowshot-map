...
It extends gdataservice.GDataService and as such hides all the
...
Example:
  import gdataphotos, gdataphotos.service
  pws = gdataphotos.service.PhotosService()
  ...
  photo.rotation = gdataphotos.Rotation(text='90') 
...
class PhotosService(gdataservice.GDataService):
  ...
  def __init__(self, email=None, password=None, source=None,
    ...
    Args:
      ...
      **kwargs: The other parameters to pass to gdataservice.GDataService
          constructor.
    """
    self.email = email
    self.client = source
    gdataservice.GDataService.__init__(
  ...
  def GetFeed(self, uri, limit=None, start_index=None):
    ...
    Returns:
    one of gdataphotos.AlbumFeed,
           gdataphotos.UserFeed,
           gdataphotos.PhotoFeed,
           gdataphotos.CommentFeed,
           gdataphotos.TagFeed,
    ...
    try:
      return self.Get(uri, converter=gdataphotos.AnyFeedFromString)
    except gdataservice.RequestError, e:
  ...
  def GetEntry(self, uri, limit=None, start_index=None):
    ...
    Returns:
    one of gdataphotos.AlbumEntry,
           gdataphotos.UserEntry,
           gdataphotos.PhotoEntry,
           gdataphotos.CommentEntry,
           gdataphotos.TagEntry,
      depending on the results of the query.
    Raises:
    GooglePhotosException
    """
    ...
    if start_index is not None:
      uri += '&start-index=%s' % start_index
    try:
      return self.Get(uri, converter=gdataphotos.AnyEntryFromString)
    except gdataservice.RequestError, e:
      raise GooglePhotosException(e.args[0])
  ...
  def GetUserFeed(self, kind='album', user='default', limit=None):
    ...
    Returns:
    gdataphotos.UserFeed, containing appropriate Entry elements
  ...
  def GetTaggedPhotos(self, tag, user='default', limit=None):
    ...
    Returns:
    gdataphotos.UserFeed containing PhotoEntry elements
    """
  ...
  def SearchUserPhotos(self, query, user='default', limit=100):
    ...
    Returns:
    gdataphotos.UserFeed with PhotoEntry elements
    """
  ...
  def GetContacts(self, user='default', limit=None):
    ...
    Returns
    gdataphotos.UserFeed, with UserEntry entries
  ...
  def InsertAlbum(self, title, summary, location=None, access='public',
    ...
    Returns:
    The newly created gdataphotos.AlbumEntry
    ...
    """
    album = gdataphotos.AlbumEntry()
    album.title = atom.Title(text=title, title_type='text')
    album.summary = atom.Summary(text=summary, summary_type='text')
    if location is not None:
      album.location = gdataphotos.Location(text=location)
    album.access = gdataphotos.Access(text=access)
    if commenting_enabled in ('true', 'false'):
      album.commentingEnabled = gdataphotos.CommentingEnabled(text=commenting_enabled)
    if timestamp is None:
      timestamp = '%i' % int(time.time() * 1000)
    album.timestamp = gdataphotos.Timestamp(text=timestamp)
    try:
      return self.Post(album, uri=self.userUri % self.email,
      converter=gdataphotos.AlbumEntryFromString)
    except gdataservice.RequestError, e:
      raise GooglePhotosException(e.args[0])
  ...
  def InsertPhoto(self, album_or_uri, photo, filename_or_handle,
    ...
    try:
      assert(isinstance(photo, gdataphotos.PhotoEntry))
    except AssertionError:
      raise GooglePhotosException({'status':GPHOTOS_INVALID_ARGUMENT,
        'body':'`photo` must be a gdataphotos.PhotoEntry instance',
    ...
    try:
      return self.Post(photo, uri=feed_uri, media_source=mediasource,
        converter=gdataphotos.PhotoEntryFromString)
    except gdataservice.RequestError, e:
      raise GooglePhotosException(e.args[0])
  ...
  def InsertPhotoSimple(self, album_or_uri, title, summary, filename_or_handle,
    ...
    Returns:
    The newly created gdataphotos.PhotoEntry or GooglePhotosException on errors
    ...
    metadata = gdataphotos.PhotoEntry()
  ...
  def UpdatePhotoMetadata(self, photo):
    """Update a photo's metadata. 
      ...
      * <gphoto:commentingEnabled>
      ...
      Arguments:
      photo: a gdataphotos.PhotoEntry object with updated elements

      Returns:
      The modified gdataphotos.PhotoEntry
  ...
  def UpdatePhotoBlob(self, photo_or_uri, filename_or_handle,
    ...
    Arguments:
    photo_or_uri: a gdataphotos.PhotoEntry that will be updated, or a
  ...
  def InsertTag(self, photo_or_uri, tag):
    ...
    Arguments:
    photo_or_uri: a gdataphotos.PhotoEntry that will be tagged, or a
      `post' uri pointing to it
    (string) tag: The tag/keyword

    Returns:
    The new gdataphotos.TagEntry
    ...
    """
    tag = gdataphotos.TagEntry(title=atom.Title(text=tag))
    if isinstance(photo_or_uri, (str, unicode)):
    ...
    try:
      ...
      converter=gdataphotos.TagEntryFromString)
    except gdataservice.RequestError, e:
      raise GooglePhotosException(e.args[0])
  ...
  def InsertComment(self, photo_or_uri, comment):
    ...
    Arguments:
    photo_or_uri: a gdataphotos.PhotoEntry that is about to be commented
      , or a `post' uri pointing to it
    (string) comment: The actual comment

    Returns:
    The new gdataphotos.CommentEntry
    ...
    """
    comment = gdataphotos.CommentEntry(content=atom.Content(text=comment))
    if isinstance(photo_or_uri, (str, unicode)):
      post_uri = photo_or_uri # it's a uri
    elif hasattr(photo_or_uri, 'GetEditMediaLink'):
      post_uri = photo_or_uri.GetPostLink().href
    try:
      return self.Post(data=comment, uri=post_uri,
        converter=gdataphotos.CommentEntryFromString)
    except gdataservice.RequestError, e:
      raise GooglePhotosException(e.args[0])
  ...
  def Delete(self, object_or_uri, *args, **kwargs):
    ...
    try:
      ...
      uri = object_or_uri
    try:
      return gdataservice.GDataService.Delete(self, uri, *args, **kwargs)
    except gdataservice.RequestError, e:
      raise GooglePhotosException(e.args[0])
